This example demonstrates the usage of the List & Label .NET component (https://www.combit.net/en/reporting-tool) in Java with the third party component Javonet (https://www.javonet.com). This sample is using strongly-typed wrapper for the combit List & Label .NET component combit.ListLabel23.jar. Wrapper exposes only the key operations required for this sample:
